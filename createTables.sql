...
CREATE TABLE Participants (event_id INTEGER, user_id INTEGER NOT NULL, confirmation VARCHAR2(100) NOT NULL, 
                           PRIMARY KEY (event_id, user_id),
                           FOREIGN KEY (user_id) REFERENCES Users(user_id) ON DELETE SET NULL, 
                           FOREIGN KEY (event_id) REFERENCES User_Events(event_id) ON DELETE SET NULL);
